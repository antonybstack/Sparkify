...
``` shell
$serviceName = "FeedProcessor"
$deploymentPath = "C:\dev\FeedProcessor\Release"
...
New-Service -Name $serviceName -BinaryPathName $deploymentPath"\FeedProcessor.exe" -Credential $serviceUser -Description "Web API" -DisplayName $serviceName -StartupType Automatic
...
$serviceName = "FeedProcessor"
$deploymentPath = "C:\dev\FeedProcessor\Release"
$backupPath = "C:\dev\FeedProcessor\Backups"
$newDeploymentFilesPath = "C:\dev\FeedProcessor\Publish"
